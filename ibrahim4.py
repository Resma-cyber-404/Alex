...
"""%(N))                                                    
───────────────────────────────────────────────────────
 [\x1b[1;96m+%s] Nama       : Ibrahim
 [\x1b[1;96m+%s] WhatsApp   : 01307213545
 [\x1b[1;96m+%s] Facebook   : Alex Ibrahim
 [\x1b[1;96m+%s] Github      : ibrahimresma
───────────────────────────────────────────────────────\n'''%(N,N,N,N))
def kontol():
    os.system("clear")
...
{B} |
{P}[•] AUTHOR: ibrahim
{P}[•] WHATSAPP: 01307213545
{B}[•] FACEBOOK: Alex Ibrahim""")
def licensi():#line:42
  try :#line:43
    os .system ('clear')
    kontol()
...
""")#line:49
    ...
    if OOO00O0OOO00OO00O in ['1','01']:#line:51
      print (f"{H}[{P}!{H}]{P} Anda Akan Diarahkan Ke Whatsapp...");time .sleep (3 );os .system ('xdg-open https://wa.me/+8801307213545?text=Bang+Yogi+Beli+Lisensi');exit ()#line:52
